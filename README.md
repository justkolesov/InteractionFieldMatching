...
- `notebooks/IFMCelebaGeneration.ipynb` - the notebook of unconditional generation with [CelebA](https://www.kaggle.com/datasets/jessicali9530/celeba-dataset) dataset.
